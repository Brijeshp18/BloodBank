...
function Organization({userType}) {
  ...
  const getData = async () => {
    try {
      ...
      //const response = (await  userType) === "donor" ? GetAllOrganizationsOfADonar() : GetAllOrganizationsOfAHospital();
      let response = null;
  ...
  return (
    <div>
      ...
      title = {userType === 'donor' ? "Donation History" : "consumption History"}
      centered
